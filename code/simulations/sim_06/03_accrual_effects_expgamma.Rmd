...
```{r}
d <- lapply(1:nsim, trial_dat, N, t0, delta, enro_rate = 4)
cl <- makeCluster(parallel::detectCores() - 2, outfile="")
registerDoParallel(cl)
#registerDoSEQ()
results <- foreach(i = 1:nsim,
...
Shows the relationship between power and accrual in tte context. With moderate time to events (i.e. not instantaneous) slower accrual implies  
