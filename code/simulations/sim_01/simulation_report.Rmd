...
Each example has two sets of plots. In the upper two plots, the blue line shows true difference in seroconversion probability and true ratio of median survival times respectively. "Credible intervals" are just Wald based -- they serve as an indicative interval around the estimate -- don't take them too literally. In the lower two plots are the predictive probabilities at the interim (red dots) and projected to the end of the trial assuming all resources are expended (blue dots). In the case of the clinical endpoint, the predicted probability at the interim is just the probability that the ratio of medians is greater than 1.
...
Figure 1 shows the point estimates and 95% intervals frofor the parameters of interest computed from the data observed at the interim analyses. Trial was abandoned (futile) on the basis of immunological results. Probability of successful trial assuming all resources were expended was 0.014.


```{r, echo = F, fig.align='center', fig.width=6, fig.height=6, eval = F}
...
Figure 2 shows the point estimates and 95% intervals for the parameters of interest computed from the data observed at the interim analyses. Trial was abandoned (futile) on the basis of immunological results. Probability of successful trial assuming all resources were expended was 0.002.
...
Figure 4 shows the point estimates and 95% intervals for the parameters of interest computed from the data observed at the interim analyses. Trial deemed successful (superiority). Venous sampling not stopped. Probability of effect in the clinical endpoint based on the interim assessment was 0.978. 
...
# Null01 SeroTrt01 ClinTrt01 ClinTrt02 ClinSeroTrt01 ClinSeroTrt02 ClinSeroTrt03 ClinSeroTrt04
kable(df_0 %>% dplyr::filter(idsim == "Null01") %>% dplyr::select(-fname, -idsim, -nsim) %>%
...
```{r, echo = F}
# Null01 SeroTrt01 ClinTrt01 ClinTrt02 ClinSeroTrt01 ClinSeroTrt02 ClinSeroTrt03 ClinSeroTrt04
kable(df_0 %>% dplyr::filter(idsim == "SeroTrt01") %>% dplyr::select(-fname, -idsim, -nsim) %>%
...
```{r, echo = F, eval = F}
# Null01 SeroTrt01 ClinTrt01 ClinTrt02 ClinSeroTrt01 ClinSeroTrt02 ClinSeroTrt03 ClinSeroTrt04
kable(df_0 %>% dplyr::filter(idsim == "ClinTrt01") %>% dplyr::select(-fname, -idsim, -nsim) %>%
...
```{r, echo = F, eval = F}
# Null01 SeroTrt01 ClinTrt01 ClinTrt02 ClinSeroTrt01 ClinSeroTrt02 ClinSeroTrt03 ClinSeroTrt04
kable(df_0 %>% dplyr::filter(idsim == "ClinTrt02") %>% dplyr::select(-fname, -idsim, -nsim) %>%
        dplyr::arrange(baseclin, trtclin),
...
```{r, echo = F, eval = F}
# Null01 SeroTrt01 ClinTrt01 ClinTrt02 ClinSeroTrt01 ClinSeroTrt02 ClinSeroTrt03 ClinSeroTrt04
kable(df_0 %>% dplyr::filter(idsim == "ClinSeroTrt01") %>% dplyr::select(-fname, -idsim, -nsim) %>%
...
```{r, echo = F, eval = F}
# Null01 SeroTrt01 ClinTrt01 ClinTrt02 ClinSeroTrt01 ClinSeroTrt02 ClinSeroTrt03 ClinSeroTrt04
kable(df_0 %>% dplyr::filter(idsim == "ClinSeroTrt02") %>% dplyr::select(-fname, -idsim, -nsim) %>%
        dplyr::arrange(basesero, trtsero, baseclin, trtclin),
...
```{r, echo = F, eval = F}
# Null01 SeroTrt01 ClinTrt01 ClinTrt02 ClinSeroTrt01 ClinSeroTrt02 ClinSeroTrt03 ClinSeroTrt04
kable(df_0 %>% dplyr::filter(idsim == "ClinSeroTrt03") %>% dplyr::select(-fname, -idsim, -nsim) %>%
        dplyr::arrange(basesero, trtsero, baseclin, trtclin),
...
```{r, echo = F, eval = F}
# Null01 SeroTrt01 ClinTrt01 ClinTrt02 ClinSeroTrt01 ClinSeroTrt02 ClinSeroTrt03 ClinSeroTrt04
kable(df_0 %>% dplyr::filter(idsim == "ClinSeroTrt04") %>% dplyr::select(-fname, -idsim, -nsim) %>%
        dplyr::arrange(basesero, trtsero, baseclin, trtclin),
