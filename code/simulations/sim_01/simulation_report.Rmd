...
***
Note - we do not start modelling medical attendance until we have 150 participants. If we start the time to event analyses from 50 then we are going to get ridiculous results because we will see no events.
