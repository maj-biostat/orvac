...
### No seroconversion effect, no immunological effect
...
if(sum(df_0$idsim == currentsimid ) > 0) {
  ...
  kable(df_0 %>% dplyr::filter(idsim == currentsimid) %>% dplyr::select(-fname, -idsim, -nsim) %>%
...
### Small seroconversion effect, no immunological effect
...
### No seroconversion effect, small immunological effect
...
### No seroconversion effect, large immunological effect
...
### Small seroconversion effect, small immunological effect
...
### Large seroconversion effect, small immunological effect
...
### Small seroconversion effect, large immunological effect
...
### Large seroconversion effect, large immunological effect
