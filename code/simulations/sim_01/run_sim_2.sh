...
# null case
/usr/bin/Rscript main_4.R -f cfg1.yaml -o T -i "Null01" -l null_01_01.log       -n 1000 -s 9676 -a 50 -d 0.0 -b 0.3 -p 0.3 -m 30 -t 30
/usr/bin/Rscript main_4.R -f cfg1.yaml -o T -i "Null02" -l null_01_02.log       -n 1000 -s 9676 -a 30 -d 0.0 -b 0.3 -p 0.3 -m 30 -t 30
